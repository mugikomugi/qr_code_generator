      ...
      <form id="qrForm" method="post" action="">
        ...
        <div class="formGroup">
          ...
          <div class="qrImg">
            ...
            <label class="qrBox">
              ...
              <input type="radio" class="qrSize" name="qr_size" value="80" <?php echo $chaked; ?>>80px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code100.svg" alt="100pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="100" <?php echo $chaked; ?>>100px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code120.svg" alt="120pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="120" <?php echo $chaked; ?>>120px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code150.svg" alt="150pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="150" <?php echo $chaked; ?>>150px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code200.svg" alt="200pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="200" <?php echo $chaked; ?>>200px
            </label>
          </div>
          <!-- //.qrImg -->
          ...
          <div class="custam">
            ...
            <label class="qrRadioCustam">
              <input type="radio" class="qrSize" name="qr_size" value="custam_size" <?php echo $chaked; ?>>カスタムサイズ
            </label>
        ...
        <div class="formGroup">
          ...
          <div class="custam">
            ...
            <label class="qrRadioCustam">
              <input type="radio" class="qrSize" name="qr_color" value="custam_color" <?php echo $chaked; ?>>カスタムカラー
            </label>
