        ...
        <div class="formGroup">
          ...
          <div class="qrImg">
            <label class="qrBox">
              ...
              <input type="radio" class="qrSize" name="qr_size" value="60" <?php echo $cheked6; ?>>80px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code100.svg" alt="100pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="80" <?php echo $cheked8; ?>>100px
            </label>
