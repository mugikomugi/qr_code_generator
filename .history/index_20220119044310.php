...
//初期値
  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(empty($qr_color)){
      ...
      switch($qr_color){
        case 'black': $cheked_bla = 'checked'; break;
        case 'blue': $cheked_blu = 'checked'; break;
        case 'red': $cheked_red = 'checked'; break;
        case 'green': $cheked_gre = 'checked'; break;
        case 'orenge': $cheked_ore = 'checked'; break;
        case 'custam_color': $cheked_cus = 'checked'; break;
      }
      //var_dump($r_color);
      $err['color'] = '';
    }
        ...
        <div class="formGroup">
          ...
          <div class="custam">
            ...
            <label class="allSize">全体枠
              <input type="number" name="all_size" min="40" value="<?php echo $all_size; ?>">px
            </label>
            <label class="allSize">余白
              <input type="number" name="in_size" min="4" value="<?php echo $in_size; ?>">px
            </label>
          </div>
          <!-- //.custam -->
        </div>
