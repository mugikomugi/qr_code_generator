        ...
        <div class="formGroup">
          ...
          <div class="qrImg">
            ...
            <label class="qrBox">
              ...
              <input type="radio" class="qrSize" name="qr_size" value="80" <?php echo $cheked; ?>>80px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code100.svg" alt="100pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="100" <?php echo $cheked; ?>>100px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code120.svg" alt="120pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="120" <?php echo $cheked; ?>>120px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code150.svg" alt="150pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="150" <?php echo $cheked; ?>>150px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code200.svg" alt="200pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="200" <?php echo $cheked; ?>>200px
            </label>
          </div>
          <!-- //.qrImg -->
          ...
          <div class="custam">
            ...
            <label class="qrRadioCustam">
              <input type="radio" class="qrSize" name="qr_size" value="custam_size" <?php echo $cheked; ?>>カスタムサイズ
            </label>
        ...
        <div class="formGroup">
          ...
          <div class="qrImg">
            <label class="qrBox">
              ...
              <input type="radio" class="qrSize" name="qr_color" value="black">黒
            </label>
            <label class="qrBox">
          ...
          <div class="custam">
            ...
            <label class="qrRadioCustam">
              <input type="radio" class="qrSize" name="qr_color" value="custam_color" <?php echo $cheked; ?>>カスタムカラー
            </label>
