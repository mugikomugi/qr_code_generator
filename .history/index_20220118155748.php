<?php
  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(isset($qr_size === 'custam_size')){
      if($_POST['all_size'] === '' || $_POST['in_size'] === ''){
        $err['all_size'] = '<p class="err"><span class="material-icons-outlined">error_outline</span>カスタムサイズの指定がありません</p>';
      }
    } else {
      $err['all_size'] = '';
    }
    ...
    <main class="main">
      ...
      <form id="qrForm" method="post" action="">
        ...
        <div class="formGroup">
          ...
          <?php echo $err['size']; ?><?php echo $err['all_size']; ?>
          <div class="qrImg">
            <label class="qrBox">
