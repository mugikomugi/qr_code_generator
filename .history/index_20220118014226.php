    ...
    <main class="main">
      ...
      <form id="qrForm" method="post" action="">
        <div class="formGroup">
          ...
          <p class="err"><span class="material-icons-outlined">error_outline</span>未入力です</p>
          <input type="text" class="inputText" name="qr_text">
        </div>

        <div class="formGroup">
          <p class="groupNum"><span>2</span>サイズを選んでください(余白は10px程取っています)</p>
          <p class="err"><span class="material-icons-outlined">error_outline</span>未選択です</p>
          <div class="qrImg">
            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code60.svg" alt="60pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="60">60px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code80.svg" alt="80pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="80">80px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code100.svg" alt="100pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="100">100px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code120.svg" alt="120pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="120">120px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code150.svg" alt="150pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="150">150px
            </label>

            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code200.svg" alt="200pxサイズ">
              <input type="radio" class="qrSize" name="qr_size" value="200">200px
            </label>
          </div>
          <!-- //.qrImg -->
          ...
          <div class="custam">
            ...
            <label class="qrRadioCustam">
              <input type="radio" class="qrSize" name="qr_size" value="custam">カスタムサイズ
            </label>
            <label class="allSize">全体枠
              <input type="number" name="all_size">px
            </label>
            <label class="allSize">余白
              <input type="number" name="in_size">px
            </label>
          </div>
          <!-- //.custam -->
        </div>
        ...
        <div class="formGroup">
          ...
          <div class="qrImg">
            <label class="qrBox">
              ...
              <input type="radio" class="qrSize" name="qr_color" value="black" checked>黒
            </label>
            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code80red.svg" alt="赤">
              <input type="radio" class="qrSize" name="qr_color" value="red">赤
            </label>
            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code80bl.svg" alt="青">
              <input type="radio" class="qrSize" name="qr_color" value="blue">青
            </label>
            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code80gree.svg" alt="緑">
              <input type="radio" class="qrSize" name="qr_color" value="green">緑
            </label>
            <label class="qrBox">
              <img class="sizeImg" src="image/qr_code80ore.svg" alt="オレンジ">
              <input type="radio" class="qrSize" name="qr_color" value="orenge">オレンジ
            </label>
          </div>
          <!-- //.qrImg -->
          ...
          <div class="custam">
            ...
            <label class="qrRadioCustam">
              <input type="radio" class="qrSize" name="qr_color" value="custam">カスタムカラー
            </label>
            <label class="allSize">R
              <input type="number" name="r_color">
            </label>
            <label class="allSize">G
              <input type="number" name="g_color">
            </label>
            <label class="allSize">B
              <input type="number" name="b_color">
            </label>
          </div>
          <!-- //.custam -->
        </div>
        ...
        <div class="formGroup">
          ...
          <p class="err"><span class="material-icons-outlined">error_outline</span>未選択です</p>
          <label class="qrMold">
            <input type="radio" class="qrSize" name="qr_type" value="png" checked>PNG(推奨形式)
          </label>
          <label class="qrMold">
